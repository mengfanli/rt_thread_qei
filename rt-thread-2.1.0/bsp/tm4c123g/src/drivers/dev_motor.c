...
void motor_set_throttle(motor_side_e side, int speed)
{
    ...
    if(side == MOTOR_LEFT)
    {
        if(speed >= 0)
        {
            ...
            debug_printf("LEFT %04d FRONT:%10d BACK:%04d", speed,(rt_uint32_t)pulse_width,1);
        }
        else
        {
            ...
            debug_printf("LEFT %04d FRONT:%04d BACK:%10d", speed,1,(rt_uint32_t)pulse_width);
        }
    ...
    else
    {
        if(speed >= 0)
        {
            ...
            debug_printf("RIGHT %04d FRONT:%10d BACK:%04d", speed,(rt_uint32_t)pulse_width,1);
        }
        else
        {
            ...
            debug_printf("RIGHT %04d FRONT:%04d BACK:%10d", speed,1,(rt_uint32_t)pulse_width);
        }
    }
...
void motor_monitor_thread_entry(void *param)
{
    ...
    while(1)
    {
        ...
        for(int index = 0; index < MOTOR_NUM; index++)
        {
            ...
            output = vel_pid_update(vel_pid_array + index, qei_data_array[index].velocity, 0.1);
