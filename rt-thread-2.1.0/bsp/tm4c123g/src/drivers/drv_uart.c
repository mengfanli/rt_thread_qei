...
static rt_err_t hw_configure(struct rt_serial_device *serial,
        struct serial_configure *cfg)
{
    ...
    MAP_UARTConfigSetExpClk(uart->hw_base, MAP_SysCtlClockGet(), cfg->baud_rate,
            config);
...
static const struct rt_uart_ops hw_uart_ops = { hw_configure, hw_control,
        hw_putc, hw_getc, };

#if defined(RT_USING_UART0)
/* UART0 device driver structure */
struct rt_serial_device serial0;
hw_uart_t uart0 = { UART0_BASE, };
